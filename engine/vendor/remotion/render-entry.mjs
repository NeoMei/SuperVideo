// Derived from @remotion/studio 4.0.522 (MIT). See NOTICE.md and provenance.json.
// Modified by SuperVideo: remove Studio loading/spinner/unused imports; inline two colors.
...
var renderContent = (Root) => {
    ...
    const markup = /* @__PURE__ */ jsx(Internals.CompositionManagerProvider, {
      ...
      children: /* @__PURE__ */ jsx(Internals.RemotionRootContexts, {
        ...
        children: /* @__PURE__ */ jsxs(Internals.RenderAssetManagerProvider, {
          collectAssets: null,
          children: [
            // SuperVideo read-only controls share the composition timeline.
            window.supervideo_previewControls ? jsx(window.supervideo_previewControls, {state: bundleMode}) : null,
            /* @__PURE__ */ jsx(Root, {}),
  ...
  // SuperVideo: index mode deliberately has no Studio UI.
